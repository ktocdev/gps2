...
**Files Created/Modified:**
- `src/composables/3d-models/food/vegetables.ts` - Added `createCarrotStick()`
- `src/composables/3d-models/index.ts` - Exported carrot function
- `src/composables/3d-models/containers/bowls.ts` - Added food model routing
- `src/components/debug/prototypes/ModelViewerDebug.vue` - Added carrot to model viewer
