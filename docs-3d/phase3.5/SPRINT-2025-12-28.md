...
**Workaround:** Go to the supplies store and buy a new version of the item.

**Notes:** Likely a state synchronization issue between inventory store and 3D scene on page refresh.
