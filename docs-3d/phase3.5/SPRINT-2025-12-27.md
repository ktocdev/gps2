...
**Priority:** HIGH (P1)
**Category:** Feature
**Status:** BLOCKED - Must complete before Playing and Chewing behaviors
...
- Physics state management (locked, controlled, free)

**Files to Create/Modify:**
- `src/composables/3d/use3DPhysics.ts` - New physics composable
- `src/composables/3d/use3DBehavior.ts` - Integrate physics state with behaviors
...
**Status:** BLOCKED on Physics for Playing/Chewing
...
- [ ] **Playing** - Find toys, play animation, satisfy play need
  - Requires: Physics system for controlled item interaction
  - Physics state: "controlled" during play
...
**Files to Modify:**
- `src/composables/3d/use3DBehavior.ts` - Add play/chew behavior logic
- `src/composables/use3DGuineaPig.ts` - Add play/chew animations
