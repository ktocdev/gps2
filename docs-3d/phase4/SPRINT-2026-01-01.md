...
### Health Need - Keep or Remove?
**Source:** todos.md

**Question:** Is the Health need a real need? Should we keep it? It is not shown in the Needs Debug panel.

**To Do:**
- [ ] Investigate if Health need is used in game logic
- [ ] Decide whether to add it to debug panel or remove it from the system
...
- [ ] CSS logical properties (no physical margin/padding)
- [ ] CSS variables usage
