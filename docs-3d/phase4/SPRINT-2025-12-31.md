...
**Status:** 📋 Planned
**Goal:** Player-triggered GP-to-GP social interactions via FAB menu
...
- **Button color:** Dark red-orange - warm/social, balances icon contrast, visible over sky/habitat
- **CSS:** New `game-fab--red-orange` class with darker `--color-warning-600` or custom `#d45a00`
- **Location:** Right FAB container, below Habitat Care

**Tasks:**
- [ ] Add `game-fab--red-orange` color variant to `game-fab.css`
- [ ] Add GP-to-GP FAB button (👯 red-orange)
- [ ] Create FabSubnavMenu with social actions
- [ ] Wire up actions to `useSocialBehaviors.ts` functions
- [ ] Add 3D animations for social interactions (approach, play, groom)
- [ ] Trigger via debug slider (social need) for autonomous behavior testing

**Social Actions Menu:**
- Approach Companion
- Play Together
- Groom Partner (Friends/Bonded tier)
- Share Food (near food)
- Greet
