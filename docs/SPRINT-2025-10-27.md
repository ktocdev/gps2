...
##### Autonomous Sleep Not Triggering 🔥 **HIGH PRIORITY**
**Priority:** CRITICAL
**Status:** 📋 Not Started

**Issue:** Guinea pigs' energy needs fall to 0% because they fail to autonomously seek sleep

**Observed Behavior:**
- After running game for extended period, guinea pigs don't sleep on their own
- Energy need degrades to 0% without triggering sleep behavior
- Autonomous sleep-seeking appears to be broken

**Investigation Required:**
- Verify sleep behavior is in autonomous decision matrix
- Check energy threshold for triggering sleep (currently set to 40%)
- Verify sleep goals are being generated when energy is low
- Check if other behaviors are blocking sleep execution
- Review behavior priority system

**Files to Check:**
- `src/composables/game/useGuineaPigBehavior.ts` - Sleep behavior selection logic
- `src/composables/game/useGuineaPigBehavior.ts` - DEFAULT_THRESHOLDS (line 62-68)
...
- 🔥 **Autonomous sleep triggering verified** (CRITICAL - energy falling to 0%)
