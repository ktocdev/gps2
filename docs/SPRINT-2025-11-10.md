...
**Investigation Needed:**
- Check guineaPigStore persistence configuration
- Verify bonds array is included in persisted state
- Compare with user friendship persistence (which works)
- Check if bonds are being loaded on store initialization

**Files to Check:**
- [guineaPigStore.ts](../src/stores/guineaPigStore.ts) - Store persistence and bonds data structure
