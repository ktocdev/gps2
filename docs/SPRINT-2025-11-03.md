...
- ✅ Treats Can Now Be Hand-Fed (added treats category to food dialog)
- ✅ Fill Hay Rack Buttons Added (global + individual buttons for quick refills)
...
**Implementation:**
- Added "Treats" category to food selection dialog with 🍪 emoji
...
- Works with the two-step confirmation process (select treat → click Feed button)
...
const foodCategories = [
  ...
  { id: 'treats', label: 'Treats', emoji: '🍪' } // ← NEW
]
```
...
- ✅ Players can hand-feed treats to guinea pigs
- ✅ Treats consumed from inventory when hand-fed
...
**Current Behavior:**
- ✅ Global "Fill All Hay Racks" button in Habitat Care Sidebar (Core Care section)
- ✅ Individual "Fill Rack" button in each hay rack's popover
- ✅ Smart disabled states with contextual tooltips
- ✅ Both buttons use available hay from inventory
- ✅ Automatically consumes servings from inventory
- ✅ Activity feed logging for global fill action
- ✅ Console logging for individual rack fills

**Benefits:**
- ✅ Significantly faster hay rack management
- ✅ Handles multiple hay racks intelligently
- ✅ Consistent UX pattern with Refill Bedding button
- ✅ Flexible: bulk fill OR targeted fill
- ✅ Eliminates tedious manual dragging
...
- **New Features**
  ...
  - ✅ Treats can now be hand-fed (added treats category to food dialog)
  - ✅ Fill Hay Rack buttons (global + individual for quick refills)
...
- ✅ ~~Treats cannot be hand-fed~~ - COMPLETED
