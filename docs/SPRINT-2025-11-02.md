...
#### Hay System Display & Duplication Bug 🔥 **CRITICAL - ACTIVE**
**Priority:** CRITICAL
**Status:** 🔥 Active Bug - Multiple Hay Issues
...
- Display bug shows wrong hay rack capacity (1/1 vs 1/4)
- Eating hay incorrectly adds hay back to inventory
- Both bugs appear to stem from hay tracking/inventory management logic
...
#### Item Tooltips Disappear Before Clicking 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
**Category:** UI/UX
...
1. Add `hideDelay` timer in HabitatItemPopover component
2. On item `@mouseleave`, start 200ms timer to hide tooltip
3. On tooltip `@mouseenter`, cancel hide timer
4. On tooltip `@mouseleave`, hide immediately
5. Ensure tooltip has `@mouseenter` and `@mouseleave` handlers

**Files to Modify:**
- [HabitatItemPopover.vue](../src/components/game/habitat/HabitatItemPopover.vue) - Add hover grace period logic
- [FoodBowl.vue](../src/components/game/habitat/FoodBowl.vue) - May need to adjust hover handlers
- [HayRack.vue](../src/components/game/habitat/HayRack.vue) - May need to adjust hover handlers
- [WaterBottle.vue](../src/components/game/habitat/WaterBottle.vue) - May need to adjust hover handlers
- [ChewItem.vue](../src/components/game/habitat/ChewItem.vue) - May need to adjust hover handlers

**Testing:**
- Hover over item to show tooltip
- Slowly move mouse from item to tooltip
- Verify tooltip stays open during transition
- Click button in tooltip (e.g., "Refill Water")
...
#### Guinea Pig Wiggle When Chewing 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
...
#### Guinea Pig Wiggle During Player Interaction 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
**Category:** Animations & Polish
...
#### Hand-Feed Food Selection Menu 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
...
#### Gentle Pet Wipe Interaction 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
...
**Desired Behavior:**
- New socialize action: **"Use gentle pet wipe"**
- Player selects guinea pig and clicks "Use gentle pet wipe"
- Hygiene need increases (e.g., +15-20 points)
- Activity feed message: "[Player] gently wipes down [Guinea pig name]"
- Optional: Show wiggle animation during wiping
- Optional: Cooldown period to prevent spam (e.g., once per 5 minutes per guinea pig)

**Implementation Requirements:**
1. Add "Use gentle pet wipe" to socialize actions menu
2. Create hygiene increase function in guinea pig store
3. Apply hygiene boost when interaction is used
4. Generate appropriate activity feed message
5. Add cooldown tracking (optional but recommended)
6. Consider adding gentle pet wipes as inventory item (optional)

**Files to Modify:**
- Socialize actions menu (wherever pet, hold, hand-feed actions are defined)
- [guineaPigStore.ts](../src/stores/guineaPigStore.ts) - Add hygiene increase method
- [messageGenerator.ts](../src/utils/messageGenerator.ts) - Add pet wipe message templates
- [useGuineaPigBehavior.ts](../src/composables/game/useGuineaPigBehavior.ts) - Pet wipe interaction logic

**Design Considerations:**
- Should pet wipes be an inventory item that gets consumed? Or unlimited action?
- Should there be a cooldown to prevent abuse?
- How much hygiene boost? (suggestion: +15-20, enough to be helpful but not OP)
- Should guinea pig personality affect effectiveness? (e.g., high cleanliness guinea pigs appreciate it more)

**Future Enhancement:**
- Add "Gentle Pet Wipes" item to supplies store
- Consume one wipe per use
- Different wipe types with different effectiveness

---

### Social Bonding Enhancements 🤝

#### Sleeping Together Bonding Bonus 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
...
### Smart Bedding System 📋 **NOT STARTED**
**Priority:** HIGH
**Status:** 📋 Not Started
...
### Food Serving Guide 📋 **NOT STARTED**
**Priority:** MEDIUM
**Status:** 📋 Not Started
...
## 🎯 **Future Enhancements (From Previous Sprint)**
...
- [ ] **Hay system bugs fixed (CRITICAL)** - Duplication + display issues
  - Inventory duplication when dragging hay to rack
  - Hay rack servings display showing wrong capacity
