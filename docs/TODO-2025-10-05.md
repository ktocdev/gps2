...
- [ ] Add personality trait modifiers to guinea pig store
- [ ] Implement need decay rate calculations with personality
- [ ] Create interaction effectiveness modifiers
- [ ] Add personality-based reaction logic
- [ ] Build Personality Debug panel with trait adjustment
- [ ] Add decay rate preview calculator
- [ ] Test personality effects on gameplay

**Files to Update:**
- `src/stores/guineaPigStore.ts` (add personality methods)
- `src/stores/needsController.ts` (add personality modifiers to decay)
...
- [ ] Add preferences data structure to guinea pig
- [ ] Implement hidden preference system (favorites/neutral/dislikes)
- [ ] Create preference response modifiers (+50%, -30%)
- [ ] Add rejection logic for disliked items (50-70%)
- [ ] Update interaction methods with preference checks
- [ ] Build Preferences Debug panel
- [ ] Add preference testing controls

**Files to Update:**
- `src/stores/guineaPigStore.ts` (add preference methods)

**Files to Create:**
- `src/components/debug/PreferencesDebug.vue`
...
- [ ] Build Wellness Reaction Debug panel
- [ ] Add success rate calculator UI
...
**Files to Create:**
- `src/components/debug/WellnessReactionDebug.vue`
...
- [ ] Build Activity Message Debug panel
- [ ] Add message preview and throttle testing

**Files to Update:**
- `src/stores/needsController.ts` (add warning system)
- `src/stores/activityFeed.ts` (add message categories)
- `src/composables/messageGenerator.ts` (add new templates)

**Files to Create:**
- `src/components/debug/ActivityMessageDebug.vue`
...
- [ ] Debug panel organization (5 new panels)
...
- Personality Trait Influences (1) - Not Started
- Preferences: Likes & Dislikes (2) - Not Started
