...
**Status:** 🟢 In Progress - System 19 Phase 3/4 Complete
**Priority:** HIGH
**Estimated Time:** 15-25 hours

### System 19: Autonomous AI Behaviors ✅ **Phases 1-4 Complete**
...
- ✅ **Debug Tools:** Autonomy threshold controls + poop debug panel

**Activity Feed Messages Implemented:**
- ✅ Eating (preference-based), drinking, sleeping (location-aware)
- ✅ Grooming, chewing, shelter seeking
- ✅ Friendship behaviors (popcorn, zoomies, watching, hiding)
- ✅ Environmental (poop dropping)

**Remaining Tasks:**
- [ ] Add activity messages for remaining behaviors (drink, hay eating, sleep, groom, chew, shelter, watch, hide)
- [ ] Integrate AI tick system into game timing loop
- [ ] Test with multiple guinea pigs simultaneously
- [ ] Add visual indicators for current behavior state
- [ ] Performance optimization for multiple guinea pigs

**Files Created/Modified:**
- `src/composables/game/useGuineaPigBehavior.ts` - Complete autonomous AI system (970 lines)
...
- `src/stores/guineaPigStore.ts` - Added lastPoopTime tracking
