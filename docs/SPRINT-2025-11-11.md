...
- [ ] Test touch device functionality
...
**Checklist:**
- [ ] No inline styles (use utility classes or component styles)
...
**Implementation:**
- Add `cursor: not-allowed` or `cursor: no-drop` to `.inventory-sidebar__item-card--readonly`
- Update hover state to clearly indicate non-interactive item
- Ensure tooltip still appears on hover

**Files to Modify:**
- [InventorySidebar.vue](../src/components/game/habitat/sidebars/InventorySidebar.vue) - Add cursor style to readonly bedding cards
